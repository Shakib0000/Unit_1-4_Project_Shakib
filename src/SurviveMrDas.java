...
public class SurviveMrDas {
    ...
    private int dasLocation; // The distance between Mr. Das and the player in feet.
    private int timer; // The amount of time left in minutes before the player falls asleep.
